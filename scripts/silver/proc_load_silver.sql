...
BEGIN
	...
	BEGIN TRY
		...
		SELECT cst_id, cst_key, 
			   ...
			   cst_create_date
		FROM
			(SELECT *, ROW_NUMBER() OVER (PARTITION BY cst_id ORDER BY cst_create_date DESC) flag2
			 FROM bronze.crm_cust_info
			 WHERE cst_id IS NOT NULL) z2
		WHERE z2.flag2 = 1;   
		...
		INSERT INTO silver.crm_prod_info (prd_id, cat_id, prd_key, prd_nm, prd_cost, prd_line, prd_start_dt, prd_end_dt)
		SELECT prd_id,
		...
		PRINT '================================';
		PRINT 'Data Transformations on the Silver layer is DONE. Loading of Silver Layer is complete';
